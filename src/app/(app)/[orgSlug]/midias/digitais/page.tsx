...
export default async function MidiasDigitaisPage({
  params,
  searchParams,
}: {
  ...
  const baseQ = (supabase as any)
    ...
    .eq('org_id', org.id).eq('tipo', 'digital')
  ...
  return (
    <MidiasClient
      ...
      basePath="midias/digitais"
      title="Liberação de mídias — Digitais"
      subtitle="Influenciadores, portais e mídia online"
      addLabel="Adicionar Mídia Digital"
    />
  )
}
