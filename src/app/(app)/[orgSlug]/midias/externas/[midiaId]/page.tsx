...
export default async function EditarExternaPage({
  ...
  const initial: ExternaValues = {
    ...
    producao_valor: s(det.producao_valor), producao_comissao_pct: s(det.producao_comissao_pct), producao_quantidade: s(det.producao_quantidade), producao_total: s(det.producao_total),
