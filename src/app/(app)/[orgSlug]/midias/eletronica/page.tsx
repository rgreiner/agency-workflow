...
export default async function MidiasEletronicaPage({
  params,
  searchParams,
}: {
  ...
  const { data: raw } = await (supabase as any)
    ...
    .eq('org_id', org.id).eq('tipo', 'eletronica').eq('archived', archivedView)
  ...
  return (
    <MidiasClient
      ...
      basePath="midias/eletronica"
      title="Liberação de mídias — Eletrônica"
      subtitle="TV e rádio"
      addLabel="Adicionar Mídia Eletrônica"
    />
  )
}
