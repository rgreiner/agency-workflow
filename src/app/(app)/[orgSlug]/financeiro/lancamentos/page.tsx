...
export default async function LancamentosPage({
  ...
  const [{ data: raw }, { data: contasRaw }, { data: settings }] = await Promise.all([
    sb.from('lancamentos')
      .select('id, tipo, origem_tipo, contato_nome, descricao, valor, valor_realizado, vencimento, competencia, situacao, nf_emitida, boleto_gerado, revisar, conta_id, categoria, centro_custo, data_liquidacao, forma_pagamento, observacao')
      .eq('org_id', orgId)
