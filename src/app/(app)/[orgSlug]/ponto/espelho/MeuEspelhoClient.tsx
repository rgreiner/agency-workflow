        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-5">
          {[
            ...
            <div key={x.l} className="rounded-xl border border-gray-200 bg-white p-3">
              ...
              {/* O dia de hoje fica fora da conta — dizer até quando ela vai
                  evita a pergunta "por que não bate com a lista?" (mig. 230). */}
              {x.l === 'Saldo do ciclo' && esp.resumo.ate && (
                <div className="text-[10px] text-gray-400 mt-1 leading-tight">
                  fechado até {esp.resumo.ate.slice(8, 10)}/{esp.resumo.ate.slice(5, 7)} · hoje entra amanhã
                </div>
              )}
