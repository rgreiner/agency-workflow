-- 229_rh_dia_futuro_nao_e_falta.sql
-- Segundo achado ao conferir o espelho do Lucas (10/08). Depois de corrigir os
-- dias anteriores à admissão (mig. 228), o resumo dele ainda acusava 92h de
-- falta — e a origem eram os **11 dias do ciclo que ainda não aconteceram**.
--
-- O ciclo da competência 08/2026 vai de 26/07 a 25/08. No dia 10/08 o espelho
-- somava como falta todo dia útil de 09/08 a 25/08, como se a pessoa já
-- devesse jornada de um dia que nem chegou. Vale para o time inteiro, não só
-- para quem entrou agora — qualquer espelho aberto no meio do mês mentia.
--
-- Regra: dia posterior a HOJE não tem carga esperada. Ele continua na lista
-- (a pessoa vê o mês inteiro), mas com esperado 0, e passa a contar quando
-- chegar. Competência já encerrada não muda em nada: lá todos os dias são
-- passados.
--
-- Definições tiradas do pg_get_functiondef (com o guard da 228 já dentro);
-- de novo, UMA linha de mudança em cada. Idempotente.
