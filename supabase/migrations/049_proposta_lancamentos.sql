-- 049_proposta_lancamentos.sql
-- A Proposta também pode ser um "job" faturado nela mesma (valor único / poucas parcelas),
-- sem gerar PP/PI/Fee. Inclui 'proposta' na geração de lançamentos por parcelas. Idempotente.
